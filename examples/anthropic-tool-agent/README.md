...
ReAct-style agent with Anthropic tool use, instrumented with [tracea](https://github.com/darshannere/tracea).
...
tracea automatically captures Anthropic LLM calls via httpx transport patching.
